...
- Static credentials can be provided by adding an alicloud_access_key_ID and alicloud_secret_access_key in management/**terraform.tfvars** file as follows:
```
region = "us-east-1"
alicloud_access_key_ID = "12345"
alicloud_secret_access_key = "12345"
```
- In addition, you need to call these variables in the provider in management/**main.tf** file as follows:
```
provider "alicloud" {
  region     = var.region
...
|   |   |   |   |   |   |
| version_license  | Version and license of the Check Point Security Management  | string  | - R81-BYOL <br/> - R81-PAYG | no  |
